      ...
      <div style={{ height: '94.3vh', background: '#3C3C3C' }}>
        <Parallax ref={parallax} pages={3}>
            ...
            <>
              <FirstCard>
                ...
                >
                  ...
                  <HomeTitleText>
                    My name is
                    <HomeTitleText style={{ color: '#FF5A5F' }}>
                      {' '}
                      Eduardo Sohne{' '}
                    </HomeTitleText>
                    and I'm a
                    <HomeTitleText style={{ color: '#ffc55a' }}>
                      {' '}
                      javascript{' '}
                    </HomeTitleText>
                    fullstack developer. Most of my experience is at the
                    front-end and already worked with a few cool things like
                    <HomeTitleText style={{ color: '#ffc55a' }}>
                      {' '}
                      node js
                    </HomeTitleText>
                    ,{' '}
                    <HomeTitleText style={{ color: '#087E8B' }}>
                      {' '}
                      typescript
                    </HomeTitleText>{' '}
                    and also with
                    <HomeTitleText style={{ color: '#42B983' }}>
                      {' '}
                      vue{' '}
                    </HomeTitleText>
                    and
                    <HomeTitleText style={{ color: '#59d3e1' }}>
                      {' '}
                      react
                    </HomeTitleText>
                    .
          ...
          >
            <SecondCard>
              <HomeTitleText>
                I made this app to try out some cool features from the
                <HomeTitleBIG style={{ color: '#59d3e1' }}>
                  {' '}
                  react{' '}
                </HomeTitleBIG>
                ecosystem as
                <HomeTitleBIG style={{ color: '#42B983' }}> vite</HomeTitleBIG>,
                fetching and caching data with
                <HomeTitleBIG style={{ color: '#eb726a' }}>
                  {' '}
                  react query
                </HomeTitleBIG>
                , animated things with{' '}
                <HomeTitleBIG style={{ color: '#59d3e1' }}>
                  {' '}
                  react spring
                </HomeTitleBIG>
                , responsivity with{' '}
                <HomeTitleBIG style={{ color: '#eb6a9c' }}>
                  styled-components
                </HomeTitleBIG>{' '}
                and more.
              </HomeTitleText>
          ...
          >
            <ThirdCard>
              <HomeTitleText style={{ color: 'black' }}>
                This app code is{' '}
                <HomeTitleBIG style={{ color: '#c26e29' }}>
                  {' '}
                  public{' '}
                </HomeTitleBIG>
              ...
              <HomeTitleText style={{ marginTop: '10px', color: '#c26e29' }}>
                Besides that you can also send me feedback about this project or
                just reach me out.
              </HomeTitleText>
              <FlexRow style={{ marginTop: '2rem', columnGap: '1rem' }}>
                <Link
                  to="https://github.com/dudusohne/fine-dash"
                  target="_blank"
                >
                  <BottomButtonWrapper>
                    <GithubREPO />
